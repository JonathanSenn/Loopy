...
def play(channel):
    print(f'playing {channel}')
    event = threading.Event()

    try:
        data, fs = sf.read('/home/pi/Documents/loopy/examples/raw_1.wav', always_2d=True)
        ...
        print("stream ok")
        with stream:
            print('Wait until playback is finished')
